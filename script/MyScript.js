...
$('input').keypress(function(e){
   if(event.which === 13){
       ...
       $(this).val("");
       $("ul").append("<li><span class = 'delete'><i class=\"fa fa-trash icon-trash\"></i></span> "+inputted+" </li>");
...
var visib = function(e){
    if(!popuptoggled){
        if(e === "warning"){
            ...
            gottenpopup.textContent = "您还没有告诉我你的待办事项呢^_^";
            popuptoggled = true;
...
uul.on("click","li",function(){
    $(this).toggleClass("marked");
});

uul.on("click","span",function(e){
